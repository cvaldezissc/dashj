...
public class CoinDefinition {
    ...
    public static final String DONATION_ADDRESS = "PEFkgGQYCM3Zxa9QcVAWnC3cjAzfmbfkYT";  //Hash Engineering donation DASH address
    ...
    // Dash 0.12.1.x
    //
    public static final int PROTOCOL_VERSION = 70215;          //version.h PROTOCOL_VERSION
    public static final int MIN_PROTOCOL_VERSION = 70215;        //version.h MIN_PROTO_VERSION
